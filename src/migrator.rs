    ...
    mod m20251001_create_stores {
        ...
        impl MigrationTrait for Migration {
            async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
                ...
                manager
                    .create_table(
                        Table::create()
                            ...
                            .col(ColumnDef::new(Stores::IsVerified).boolean().not_null().default(false))
                            .col(ColumnDef::new(Stores::Rating).float())
                            .col(ColumnDef::new(Stores::TotalProducts).integer().not_null().default(0))
                            .col(
                ...
                $$ language 'plpgsql';
            "#;
                conn.execute(Statement::from_string(DatabaseBackend::Postgres, func_sql.to_string()))
                    .await?;
            ...
            "#;
                conn.execute(Statement::from_string(DatabaseBackend::Postgres, trigger_sql.to_string()))
                    .await?;
...
mod m20251002_create_products {
        ...
        impl MigrationTrait for Migration {
            async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
                manager
                    .create_table(
                        Table::create()
                            ...
                            .col(ColumnDef::new(Products::QuantityAvailable).integer().not_null().default(0))
                            .col(
                ...
                $$ language 'plpgsql';
            "#;
                conn.execute(Statement::from_string(DatabaseBackend::Postgres, func_sql.to_string())).await?;
            ...
            "#;
                conn.execute(Statement::from_string(DatabaseBackend::Postgres, trigger_sql.to_string())).await?;
