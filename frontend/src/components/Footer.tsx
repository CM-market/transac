      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="font-bold text-xl flex items-center mb-4">
              <img
                src="/logo.png"
                alt="Transac"
                className="h-12 w-auto mr-2 custom-bg"
              />
              <span>Transac</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/products"
                  className="text-gray-600 hover:text-cm-green"
                >
              ...
              <li>
                <Link
                  to="/products?category=handcrafts"
                  className="text-gray-600 hover:text-cm-green"
                >
                  {t("footer.handcrafts")}
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-gray-600 hover:text-cm-green">
                  {t("footer.ourMission")}
                </Link>
              </li>
              <li>
